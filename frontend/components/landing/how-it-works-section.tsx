...
const steps = [
  {
    number: "01",
    title: "Assess",
    subtitle: "your GCP setup",
    description: "Upload your GCP configuration. MigrAIne analyzes your infrastructure, dependencies, and workloads for optimal AWS mapping.",
    code: `migraIne.assess({
  source: 'gcp',
  target: 'aws',
  resources: ['compute', 'storage', 'database'],
  compliance: 'SOC2',
  timeline: '2weeks'
})`,
  },
  {
    ...
    description: "Get a detailed migration roadmap. Our AI recommends optimal sequencing, identifies risks, and suggests cost optimizations.",
    code: `const plan = await migraIne.generatePlan({
  source: 'gce-instance-123',
  target: 'ec2',
  ...
  },
  {
    ...
    title: "Migrate",
    subtitle: "& verify",
    description: "Execute migration with zero downtime. Real-time monitoring ensures data integrity, validation checks pass, and rollback is always available.",
    code: `migraIne.executeMigration({
  plan: plan,
  parallel: true,
  monitoring: 'realtime',
  validation: 'strict',
...
// Migration complete in 1.5 hours`,
  },
];
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${
              ...
              <span className="block text-white/10">Migrate.</span>
            </h2>
          </div>
