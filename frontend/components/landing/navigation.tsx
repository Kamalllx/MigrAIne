      ...
      >
        ...
        >
          ...
          <a href="#" className="flex items-center gap-2 group">
            <span className={`font-display tracking-tight transition-all duration-500 ${isScrolled ? "text-xl text-foreground" : "text-2xl text-white"}`}>MigrAIne</span>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            >
              <a href="#studio">Start migration</a>
            </Button>
          </div>
